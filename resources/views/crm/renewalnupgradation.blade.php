@section('page-title', 'Renewal & Upgradation')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Renewal Lead Management !</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body table-responsive">
                    <h4 class="header-title">Renewal Lead List</h4>
                    {{-- datatable --}}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-4 mt-1 search_btn_div">
                            <button
                                class="btn btn-purple btn-rounded btn-sm waves-effect waves-light search_renewal_lead_mobile"><i
...
@section('custom-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view_user_profile', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(userResponse) {
                        ...
                        let userIncome = (parseInt(userResponse.monthly_income) / 100000)
                            .toFixed(2);
                        ...
                        var descriptionDetails = userResponse.userpreference.description;
            ...
            $(document).on('click', '.search_renewal_lead_mobile', function(e) {
                e.preventDefault();
                ...
                if (lead_mobile == '') {
                    ...
                    $.ajax({
                        ...
                        success: function(search_resp) {
                            $('.search_btn_div').html(
                                ' <button class="btn btn-purple btn-rounded btn-sm waves-effect waves-light search_renewal_lead_mobile"><i class="fas fa-search"></i></button>'
                            );
            ...
            $(document).on('click', '.assgn_to_me_btn', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(assign_response) {
                        $(".search_renewal_lead_mobile").trigger('click');
                        table_data.ajax.reload();
                    }
                });
            });
