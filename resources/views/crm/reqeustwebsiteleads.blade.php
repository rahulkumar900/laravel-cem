    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">Request Website Leads</h4>
                        <span class="message_title"></span>
                        <div class="row">
                            <div class="col-md-4">
                                <select name="income_range" id="income_range" class="form-select">
                                    <option value="">Select Max Income</option>
                                    <option value="1.25">0-25 LPA</option>
                                    <option value="3.75">2.5-5 LPA</option>
                                    <option value="6.25">5-7.5 LPA</option>
                                    <option value="8.75">7.5-10 LPA</option>
                                    <option value="12.5">10-15 LPA</option>
                                    <option value="17.5">15-20 LPA</option>
                                    <option value="22.5">20-25 LPA</option>
                                    <option value="27.5">25-30 LPA</option>
                                    <option value="42.5">35-50 LPA</option>
                                    <option value="60.0">50-70 LPA</option>
                                    <option value="85.0">70-100 LPA</option>
                                    <option value="100">1Cr+ PA</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 text-center leadrequestdiv0">
                                <button class="btn btn-success btn-sm requestFbLead" dataType="0">Assign 5
                                    Leads</button>
                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" name="alt_mob_1"
                                                        id="alt_mob_1" value="Alternate Mobile Number">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control" name="alt_mob_2"
                                                        id="alt_mob_2" value="Alternate Mobile Number">
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('addleadsfollowp') }}" method="post" id="lead_followup_form"
                        autocomplete="off">
                        @csrf
                        <input type="hidden" name="lead_type" value="0">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="date" value="{{ date('Y-m-d', strtotime('+7 days')) }}"
                                ...
                                max="{{ date('Y-m-d', strtotime('+7 days')) }}" class="form-control">
                        </div>
                        <div class="form-group mb-2">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.requestFbLead', function() {
                ...
                loadLeadByType(leadType, leadSpeed, leadIncome);
            });

            /* load website leads new logic starts */
            function loadWebsiteLeads(leadSpeed, leadIncome) {
                $.ajax({
                    url: "",
                    type: "get",
                    data: {
            ...
            function loadLeadByType(leadType, leadSpeed, leadIncome) {
                $.ajax({
                    url: "{{ route('requestwebsiteleadsdata') }}",
                    type: "get",
                    data: {
                        "lead_type": leadType,
                        "lead_speed": leadSpeed,
                            ...
                            for (let i = 0; i < lfbleadResp.data.length; i++) {
                                ...
                                if (leadType == 0) {
                                    ...
                                    if (lfbleadResp.data.comments != null) {
                                        table_html +=
                                            `<a class="btn btn-primary btn-sm" data-toggle="collapse" href="#contentId${i}" aria-expanded="false" aria-controls="contentId">Show</a><div class="collapse" id="contentId${i}">`;
                                        if (lfbleadResp.data.comments != null) {
                                ...
                                if (leadType == 3 || leadType == 0) {
                                    table_html +=
                                        `<td><button class="btn btn-sm btn-success add_next_followup" id="${leadsData.id}" mobile="${leadsData.mobile}">Pickup</button></td>`;
                                } else {
                                    table_html +=
                                        `<td><button class="btn btn-sm btn-success btnPickup" id="${leadsData.id}" mobile="${leadsData.mobile}">Pickup</button></td>`;
                                }

                                table_html +=
                                    `<td><button class="btn btn-sm btn-danger btnNotpickFbLead" id="${leadsData.id}" leadName="${leadsData.name}">Not Pickup</button></td></tr>`;
                            }
                    ...
                    success: function(lfbleadRespNew) {
                        ...
                        if (lfbleadRespNew.type == true) {
                            ...
                            for (let i = 0; i < lfbleadRespNew.data.length; i++) {
                                ...
                                table_html += `<tr class="fbrow${leadsData.user_data_id}">
                                                <td scope="row">${parseInt(i)+1}</td>
                                                <td>${leadsData.name}</td>
                                ...
                                table_html += `</td><td><button class="btn btn-sm btn-success add_next_followup" id="${leadsData.id}" mobile="${leadsData.mobile}" leadName="${leadsData.name}">Pickup</button></td>
                                                <td><button class="btn btn-sm btn-danger btnNotpickFbLead" id="${leadsData.id}" user_data_id="${leadsData.user_data_id}">Not Pickup</button></td>
                                            </tr>`;
                            }
                            table_html += `</tbody></table>`;
                            $('.displaydiv2').html(table_html);
                ...
                $.ajax({
                    ...
                    success: function(notpickupResponse) {
                        if (notpickupResponse.type == true) {
                            ...
                            if (remainLead == 0) {
                                localStorage.removeItem('lead_type');
                                $('.leadrequestdiv0').html(
                                    '<button class="btn btn-success btn-sm requestFbLead" dataType="0">Request Website Leads</button>'
                                );
                            }
